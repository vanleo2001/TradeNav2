...
Begin VB.Form frmOwnerLookup 
   ...
   Begin HexUniControls.ctlUniFrameWL fraLookup 
      ...
      EndProperty
      Caption         =   "frmOwnerLookup.frx":0000
      Enabled         =   -1  'True
      ForeColor       =   -2147483642
      BackColor       =   -2147483633
      Tip             =   "frmOwnerLookup.frx":0020
      VistaStyle      =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmOwnerLookup.frx":0040
      RightToLeft     =   0   'False
      Begin HexUniControls.ctlUniButtonImageXP cmdFind 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":005C
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         ShowFocus       =   -1  'True
         Tristate        =   0   'False
         Pressed         =   0   'False
         Tip             =   "frmOwnerLookup.frx":0084
         Style           =   -1
         RoundedBorders  =   -1  'True
         xTranspColor    =   0
         yTranspColor    =   0
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":00A4
         RightToLeft     =   0   'False
      End
      Begin HexUniControls.ctlUniTextBoxXP txtFind 
         ...
         Tip             =   "frmOwnerLookup.frx":00E0
         HideSelection   =   -1  'True
         RightToLeft     =   0   'False
         ManualStart     =   0   'False
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":0100
      End
      Begin HexUniControls.ctlUniRadioXP optContains 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":011C
         Enabled         =   -1  'True
         Align           =   0
         ...
         ForeColor       =   -2147483630
         Pressed         =   0   'False
         Tip             =   "frmOwnerLookup.frx":014E
         Style           =   -1
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":016E
         ShowFocus       =   -1  'True
         RightToLeft     =   0   'False
      End
      Begin HexUniControls.ctlUniRadioXP optCustomer 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":018A
         Enabled         =   -1  'True
         Align           =   0
         RadioBackColor  =   -2147483643
         RadioForeColor  =   -2147483640
         ...
         ForeColor       =   -2147483630
         Pressed         =   0   'False
         Tip             =   "frmOwnerLookup.frx":01D4
         Style           =   -1
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":01F4
         ShowFocus       =   -1  'True
         RightToLeft     =   0   'False
      End
      Begin HexUniControls.ctlUniRadioXP optAccount 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":0210
         Enabled         =   -1  'True
         Align           =   0
         RadioBackColor  =   -2147483643
         RadioForeColor  =   -2147483640
         ...
         ForeColor       =   -2147483630
         Pressed         =   0   'False
         Tip             =   "frmOwnerLookup.frx":0258
         Style           =   -1
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":0278
         ShowFocus       =   -1  'True
         RightToLeft     =   0   'False
      End
      Begin HexUniControls.ctlUniLabelXP lblFind 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":0294
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   0
         VAlignment      =   0
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frmOwnerLookup.frx":02C0
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":02E0
         RightToLeft     =   0   'False
         WordWrap        =   0   'False
      End
   End
   ...
   Begin HexUniControls.ctlUniFrameWL fraButtons 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmOwnerLookup.frx":02FC
      Enabled         =   -1  'True
      ForeColor       =   -2147483642
      BackColor       =   -2147483633
      Tip             =   "frmOwnerLookup.frx":0328
      VistaStyle      =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmOwnerLookup.frx":0348
      RightToLeft     =   0   'False
      Begin HexUniControls.ctlUniButtonImageXP cmdAdd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":0364
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         ShowFocus       =   -1  'True
         Tristate        =   0   'False
         Pressed         =   0   'False
         Tip             =   "frmOwnerLookup.frx":038C
         Style           =   -1
         RoundedBorders  =   -1  'True
         xTranspColor    =   0
         yTranspColor    =   0
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":03AC
         RightToLeft     =   0   'False
      End
      Begin HexUniControls.ctlUniButtonImageXP cmdCancel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":03C8
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         ShowFocus       =   -1  'True
         Tristate        =   0   'False
         Pressed         =   0   'False
         Tip             =   "frmOwnerLookup.frx":03F6
         Style           =   -1
         RoundedBorders  =   -1  'True
         xTranspColor    =   0
         yTranspColor    =   0
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":0416
         RightToLeft     =   0   'False
      End
      Begin HexUniControls.ctlUniButtonImageXP cmdOK 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frmOwnerLookup.frx":0432
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         ShowFocus       =   -1  'True
         Tristate        =   0   'False
         Pressed         =   0   'False
         Tip             =   "frmOwnerLookup.frx":0458
         Style           =   -1
         RoundedBorders  =   -1  'True
         xTranspColor    =   0
         yTranspColor    =   0
         MousePointer    =   0
         MouseIcon       =   "frmOwnerLookup.frx":0478
         RightToLeft     =   0   'False
      End
   End
End
Attribute VB_Name = "frmOwnerLookup"
...
'' 04/15/2014   DAJ         Moved into cattle DLL and modified
...
ErrSection:
    Unload Me
    RaiseError "frmOwnerLookup.ShowMe"
...
ErrSection:
    RaiseError "frmOwnerLookup.Cattle_Customer"
...
ErrSection:
    RaiseError "frmOwnerLookup.cmdAdd_Click"
...
ErrSection:
    RaiseError "frmOwnerLookup.cmdCancel_Click"
...
ErrSection:
    RaiseError "frmOwnerLookup.cmdFind_Click"
...
ErrSection:
    RaiseError "frmOwnerLookup.cmdOK_Click"
...
ErrSection:
    RaiseError "frmOwnerLookup.fgAccounts_AfterSort"
...
ErrSection:
    RaiseError "frmOwnerLookup.fgAccounts_DblClick"
...
ErrSection:
    RaiseError "frmOwnerLookup.Form_Activate"
...
On Error GoTo ErrSection:
    ...
    strPlacement = GetIniFileProperty("frmOwnerLookup", "", "Placement", g.strIniFile)
...
ErrSection:
    RaiseError "frmOwnerLookup.Form_Load"
...
ErrSection:
    RaiseError "frmOwnerLookup.Form_QueryUnload"
...
On Error GoTo ErrSection:
    ...
    SetIniFileProperty "frmOwnerLookup", GetFormPlacement(Me), "Placement", g.strIniFile

ErrExit:
    Exit Sub

ErrSection:
    RaiseError "frmOwnerLookup.Form_Unload"
...
ErrSection:
    RaiseError "frmOwnerLookup.InitGrid"
...
ErrSection:
    RaiseError "frmOwnerLookup.LoadGrid"
...
ErrSection:
    RaiseError "frmOwnerLookup.optAccount_Click"
...
ErrSection:
    RaiseError "frmOwnerLookup.optContains_Click"
...
ErrSection:
    RaiseError "frmOwnerLookup.optCustomer_Click"
...
ErrSection:
    RaiseError "frmOwnerLookup.txtFind_Change"
...
ErrSection:
    RaiseError "frmOwnerLookup.FilterGrid"
...
ErrSection:
    RaiseError "frmOwnerLookup.FindRow"
...
ErrSection:
    RaiseError "frmOwnerLookup.SortGrid"
...
ErrSection:
    RaiseError "frmOwnerLookup.AccountToGrid"
